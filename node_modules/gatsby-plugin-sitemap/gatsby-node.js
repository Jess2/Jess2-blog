...
function () {
  ...
  _regenerator.default.mark(function _callee(_ref, pluginOptions) {
    var graphql, pathPrefix, options, _defaultOptions$optio, query, serialize, output, exclude, hostname, rest, saved, excludeOptions, queryRecords, urls, map, siteUrl;
          ...
          case 15:
            ...
            return _context.abrupt("return", new Promise(function (resolve) {
              ...
              var sitemapIndexOptions = (0, _extends2.default)({}, rest, {
                hostname: hostname || (0, _internals.withoutTrailingSlash)(siteUrl),
