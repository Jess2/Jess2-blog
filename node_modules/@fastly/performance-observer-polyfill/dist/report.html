...
//# sourceMappingURL=viewer.js.map
  ...
  <body>
    <div id="app"></div>
    <script>
      window.chartData = [{"label":"index.js","isAsset":true,"statSize":14431,"parsedSize":9643,"gzipSize":3318,"groups":[{"label":"src","path":"./src","statSize":14431,"groups":[{"id":0,"label":"index.ts + 3 modules (concatenated)","path":"./src/index.ts + 3 modules (concatenated)","statSize":14431,"parsedSize":7195,"gzipSize":2200,"concatenated":true,"groups":[{"label":"src","path":"./src/index.ts + 3 modules (concatenated)/src","statSize":14431,"groups":[{"id":null,"label":"index.ts","path":"./src/index.ts + 3 modules (concatenated)/src/index.ts","statSize":258,"parsedSize":128,"gzipSize":39,"inaccurateSizes":true},{"id":null,"label":"observer.ts","path":"./src/index.ts + 3 modules (concatenated)/src/observer.ts","statSize":3697,"parsedSize":1843,"gzipSize":563,"inaccurateSizes":true},{"id":null,"label":"entry-list.ts","path":"./src/index.ts + 3 modules (concatenated)/src/entry-list.ts","statSize":5685,"parsedSize":2834,"gzipSize":866,"inaccurateSizes":true},{"id":null,"label":"task-queue.ts","path":"./src/index.ts + 3 modules (concatenated)/src/task-queue.ts","statSize":4791,"parsedSize":2388,"gzipSize":730,"inaccurateSizes":true}],"parsedSize":7195,"gzipSize":2200,"inaccurateSizes":true}]}],"parsedSize":7195,"gzipSize":2200}]}];
